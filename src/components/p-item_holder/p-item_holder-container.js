...
import PortfolioThree from  '../../assets/img/img-projects/github-api-fetch.png';
...
const ProjectHolderContianer = () => {
    let projects = [
        ...
        {"id": 2, "image": `${PortfolioThree}`, "title": "Github Api Fetch", "src": "https://mark-makondo.github.io/github-api-web/"}
    ]
